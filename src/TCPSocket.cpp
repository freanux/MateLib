...
namespace Mate {
    ...
    void TCPSocket::connect(const char *ip_address, uint16_t port) throw (TCPSocketException) {
    ...
    void TCPSocket::listen(const char *address, uint16_t port, int backlog) throw (TCPSocketException) {
        struct sockaddr_in server;
        int rv;
    ...
    void TCPSocket::listen(const char *address, uint16_t port) throw (TCPSocketException) {
        listen(address, port, DefaultBacklog);
    }

    void TCPSocket::listen(uint16_t port, int backlog) throw (TCPSocketException) {
        listen(0, port, backlog);
    }

    void TCPSocket::listen(uint16_t port) throw (TCPSocketException) {
    ...
    uint16_t TCPSocket::get_port() throw (TCPSocketException) {
